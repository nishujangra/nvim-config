...
-- Rust specific key mappings (rustaceanvim uses the :RustLsp command family)
...
vim.keymap.set("n", "<leader>rc", "<cmd>RustLsp codeAction<CR>")
...
vim.keymap.set("n", "<leader>rD", "<cmd>RustLsp openDocs<CR>")
